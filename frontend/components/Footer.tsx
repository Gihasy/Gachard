      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10 pt-16 pb-10">
        <div className="grid grid-cols-1 lg:grid-cols-[1.4fr_1fr_1fr_1fr_1.2fr] gap-10">
          ...
          <div>
            ...
            <p className="text-sm text-white/60 mb-4 leading-relaxed">
              Get the latest news, events, and exclusive rewards.
            </p>
            <form
            ...
            >
              ...
              <button
                type="submit"
                className="btn-primary !py-2.5 !px-4 !text-[0.7rem]"
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5">
          ...
          <div className="flex items-center gap-3">
            <span className="text-[0.7rem] uppercase tracking-[0.18em] text-white/50 mr-1">
              Follow Us
            </span>
            {socials.map((s) => (
              <a
