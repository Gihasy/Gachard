    ...
    >
      ...
      {loading ? (
        ...
        <>
          ...
          {/* Summary bar */}
          <div
            className="glass p-4 sm:p-5 flex items-center justify-between flex-wrap gap-4 sticky bottom-4 z-10"
            style={{ borderColor: selected.size > 0 ? "rgba(125,249,255,0.3)" : undefined }}
          >
